        ...
        {canUploadMore && (
          <div
            ...
            className={`aspect-square rounded-2xl border-2 border-dashed flex flex-col items-center justify-center p-3 text-center cursor-pointer transition-all select-none ${
              isDragging
                ? 'border-[#3B52D4] bg-indigo-50/50 dark:bg-indigo-950/40'
                : 'border-slate-300 dark:border-slate-700 hover:border-[#3B52D4] bg-slate-50/40 dark:bg-slate-800/40 hover:bg-slate-100/60 dark:hover:bg-slate-800/80'
            }`}
          >
            {isUploading ? (
              <div className="flex flex-col items-center gap-1.5 text-[#3B52D4]">
