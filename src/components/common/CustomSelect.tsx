  ...
  return (
    ...
    >
      <button
        ...
        className={`flex items-center justify-between gap-2 bg-slate-100/90 dark:bg-slate-800/90 border border-slate-200/80 dark:border-slate-700/80 text-slate-800 dark:text-slate-100 hover:bg-slate-200/80 dark:hover:bg-slate-700 transition-all shadow-2xs focus:outline-none focus:ring-2 focus:ring-[#486B1C] cursor-pointer select-none ${sizeClasses} ${buttonClassName}`}
      >
            ...
            options.map((option, idx) => {
              ...
              return (
                <button
                  ...
                  className={`flex items-center justify-between w-full px-3 py-2 rounded-xl text-xs transition-all text-left cursor-pointer ${
                    isSelected
                      ? 'bg-[#486B1C] text-white font-extrabold shadow-xs'
                      : isHighlighted
