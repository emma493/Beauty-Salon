...
export const LoginModal: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-[#E3E5ED] dark:bg-slate-950 flex items-center justify-center p-4 sm:p-8 font-sans">
      ...
      <div className="w-full max-w-4xl bg-white dark:bg-slate-900 rounded-3xl shadow-2xl border border-slate-200/80 dark:border-slate-800 overflow-hidden grid grid-cols-1 md:grid-cols-2 min-h-[540px]">
        
        {/* Left Form Panel */}
        <div className="p-8 sm:p-12 flex flex-col justify-between space-y-8 bg-white dark:bg-slate-900">
          {/* Brand Header */}
          ...
          <div className="md:hidden flex flex-col items-center justify-center my-2">
            <div className="w-24 h-24 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 p-3 shadow-md flex items-center justify-center">
              <img
                src={logoUrl}
                alt="Logo"
          ...
          <div className="max-w-sm w-full mx-auto space-y-6 my-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full py-2.5 px-4 bg-[#486B1C] hover:bg-[#3b5817] text-white font-semibold text-sm rounded-xl shadow-xs transition-all duration-150 active:scale-[0.99] mt-2"
              >
                Sign In
              </button>
            </form>
