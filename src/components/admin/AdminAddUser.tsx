      ...
      <div className="space-y-6 pb-12 max-w-6xl mx-auto">
        ...
        <div className="space-y-1.5">
          <nav className="flex items-center gap-2 text-sm text-slate-500 font-medium">
            ...
            <span className="font-extrabold text-[#0A1629] dark:text-white">
              {viewMode === 'edit' ? 'Edit worker profile' : 'Register new worker'}
            </span>
          </nav>
          <h1 className="text-3xl sm:text-4xl font-black text-[#0A1629] dark:text-white tracking-tight">
              ...
              return (
                <button
                  ...
                  className={`py-4 text-sm sm:text-base whitespace-nowrap border-b-[3px] -mb-[1px] transition-all cursor-pointer flex items-center gap-2 ${
                    isActive
                      ? 'border-[#0A1629] dark:border-white text-[#0A1629] dark:text-white font-black'
          ...
          <div className="p-8 sm:p-10 space-y-8 min-h-[560px] pb-36">
            ...
            {activeTab === 'personal' && (
              <div className="space-y-7 max-w-3xl">
                <div>
                  <h3 className="text-xl font-extrabold text-[#0A1629] dark:text-white">Personal Information</h3>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-sm font-medium text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-[#0A1629] dark:focus:ring-white transition-all shadow-2xs"
                    />
                  </div>
            ...
            {activeTab === 'contact' && (
              <div className="space-y-7 max-w-3xl">
                <div>
                  <h3 className="text-xl font-extrabold text-[#0A1629] dark:text-white">Contact & Identity</h3>
                  <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  ...
                  <div className="sm:col-span-2 space-y-2">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-sm font-mono text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-[#0A1629] dark:focus:ring-white transition-all shadow-2xs"
                    />
                  </div>
                </div>
              </div>
            ...
            {activeTab === 'security' && (
              <div className="space-y-7 max-w-3xl">
                <div>
                  <h3 className="text-xl font-extrabold text-[#0A1629] dark:text-white">Account & Security</h3>
                  <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full pl-4 pr-11 py-3 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-sm font-medium text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-[#0A1629] dark:focus:ring-white transition-all shadow-2xs"
                      />
                      <button
                        type="button"
                  ...
                  <div className="p-6 bg-slate-50 dark:bg-slate-800/60 rounded-2xl border border-slate-200 dark:border-slate-700 space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        ...
                        className="px-4 py-2 bg-[#0A1629] hover:bg-black dark:bg-white dark:hover:bg-slate-200 text-white dark:text-black font-extrabold text-xs rounded-xl transition cursor-pointer shadow-xs shrink-0"
                      >
                        Generate ID
                      </button>
                    </div>
            ...
            {activeTab === 'photo' && (
              <div className="space-y-7 max-w-3xl">
                <div>
                  <h3 className="text-xl font-extrabold text-[#0A1629] dark:text-white">Avatar & Remarks</h3>
                  <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
                ...
                <div className="space-y-5">
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 items-center">
                      <div className="flex flex-col items-center justify-center space-y-2">
                        <div className="w-28 h-28 rounded-3xl overflow-hidden border-2 border-[#0A1629] dark:border-white bg-slate-100 dark:bg-slate-800 shadow-md flex items-center justify-center">
                      ...
                      <div className="sm:col-span-2 space-y-3">
                        <label
                          ...
                          className={`border-2 border-dashed rounded-2xl p-6 flex flex-col items-center justify-center text-center cursor-pointer transition-all ${
                            isDraggingAvatar
                              ? 'border-[#0A1629] dark:border-white bg-indigo-50/70 dark:bg-indigo-950/40 ring-4 ring-[#0A1629]/10'
                              : isUploadingAvatar
                              ? 'border-[#0A1629] bg-indigo-50/50 dark:bg-indigo-950/30'
                              : 'border-slate-300 dark:border-slate-700 hover:border-[#0A1629] dark:hover:border-white bg-slate-50/50 dark:bg-slate-800/40'
                          }`}
                        >
                          <input
                            type="file"
                          ...
                          />
                          {isUploadingAvatar ? (
                            <div className="flex flex-col items-center gap-2 text-[#0A1629] dark:text-white">
                              <Loader2 className="w-7 h-7 animate-spin" />
                              <span className="text-xs font-bold">Uploading to Cloudinary...</span>
                            </div>
                          ) : (
                            <div className="flex flex-col items-center gap-2 text-slate-500 dark:text-slate-400">
                              <UploadCloud className="w-8 h-8 text-[#0A1629] dark:text-white" />
                        ...
                        <div className="flex items-center gap-2">
                          <input
                            ...
                            className="flex-1 px-4 py-2.5 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-sm font-medium text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-[#0A1629] dark:focus:ring-white transition-all"
                          />
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-sm font-medium text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-[#0A1629] dark:focus:ring-white transition-all shadow-2xs placeholder:text-slate-400"
                    />
                  </div>
                </div>
              </div>
          ...
          <div className="px-6 sm:px-10 py-5 border-t border-slate-200/90 dark:border-slate-800 bg-white dark:bg-slate-900 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="px-7 py-2.5 rounded-xl bg-[#0A1629] hover:bg-black dark:bg-white dark:hover:bg-slate-200 text-white dark:text-black font-extrabold text-sm transition cursor-pointer shadow-md"
              >
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-slate-900 p-5 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-xs flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2.5 bg-[#0A1629] hover:bg-black dark:bg-white dark:hover:bg-slate-200 text-white dark:text-black font-extrabold text-sm rounded-xl shadow-md transition cursor-pointer"
        >
      ...
      <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200/80 dark:border-slate-800 shadow-sm overflow-hidden">
        <div className="p-6 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between">
          <div>
            <h3 className="text-lg font-black text-[#0A1629] dark:text-white">
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-start sm:items-center gap-4 flex-1 min-w-0">
                    <div className="relative w-14 h-14 rounded-2xl overflow-hidden border-2 border-[#0A1629]/10 dark:border-white/10 bg-slate-100 dark:bg-slate-800 shrink-0 shadow-sm group-hover:scale-105 transition-transform duration-300">
                      <img src={w.avatarUrl} alt={w.firstName} className="w-full h-full object-cover" />
                    </div>

                    <div className="min-w-0 flex-1 space-y-1">
                      <div className="flex flex-wrap items-center gap-2">
                        <h4 className="text-base font-black text-[#0A1629] dark:text-white truncate">
                          {fullName}
                        </h4>
                        <span className="px-2.5 py-0.5 rounded-md bg-[#0A1629] text-white dark:bg-white dark:text-black font-extrabold text-[10px] tracking-wider uppercase">
                          {w.role || 'WORKER'}
                        </span>
                  ...
                  <div className="flex flex-wrap items-center gap-2 shrink-0 pt-2 lg:pt-0 border-t lg:border-t-0 border-slate-100 dark:border-slate-800">
                    <button
                      ...
                      className="px-3.5 py-2 bg-slate-100 hover:bg-[#0A1629] hover:text-white dark:bg-slate-800 dark:hover:bg-white dark:hover:text-black text-slate-700 dark:text-slate-200 font-bold text-xs rounded-xl flex items-center gap-1.5 transition cursor-pointer shadow-2xs"
                    >
                    ...
                    <button
                      ...
                      className="px-3.5 py-2 bg-[#0A1629] hover:bg-black dark:bg-white dark:hover:bg-slate-200 text-white dark:text-black font-extrabold text-xs rounded-xl flex items-center gap-1.5 shadow-sm transition cursor-pointer"
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-xs p-4">
          <div className="relative w-full max-w-md bg-white dark:bg-slate-900 rounded-3xl p-6 shadow-2xl border border-slate-200 dark:border-slate-800 space-y-4">
            ...
            <div className="text-center space-y-2">
              <div className="w-20 h-20 mx-auto rounded-full overflow-hidden border-2 border-[#0A1629] dark:border-white shadow-md">
              ...
              <span className="inline-block font-mono text-xs font-bold text-[#0A1629] dark:text-white bg-slate-100 dark:bg-slate-800 px-2.5 py-1 rounded-full">
                ID: {detailWorker.id}
              </span>
            </div>
            ...
            <div className="space-y-2 text-xs border-t border-b border-slate-100 dark:border-slate-800 py-3">
              ...
              <div className="flex justify-between"><span className="text-slate-400">Password:</span> <span className="font-mono font-bold text-[#0A1629] dark:text-white">{detailWorker.password}</span></div>
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 py-2.5 bg-[#0A1629] hover:bg-black dark:bg-white dark:hover:bg-slate-200 text-white dark:text-black font-bold text-xs rounded-xl flex items-center justify-center gap-1.5 transition cursor-pointer shadow-md"
              >
            ...
            <form onSubmit={handleApplyResetPassword} className="space-y-3">
              <div className="relative">
                <input
                  ...
                  className="w-full pl-3.5 pr-10 py-2.5 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-sm font-bold text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-[#0A1629] dark:focus:ring-white transition-all"
                />
                <button
                  type="button"
              ...
              <button
                type="submit"
                className="w-full py-3 bg-[#0A1629] hover:bg-black dark:bg-white dark:hover:bg-slate-200 text-white dark:text-black font-extrabold text-sm rounded-xl shadow-md transition cursor-pointer"
              >
                Apply New Password
              </button>
            </form>
