    ...
    <div className="space-y-6 pb-12 max-w-6xl mx-auto">
      ...
      <div className="space-y-1.5">
        <nav className="flex items-center gap-2 text-sm text-slate-500 font-medium">
          ...
          <span className="font-extrabold text-[#0A1629] dark:text-white">Add new product</span>
        </nav>
        ...
        <div className="p-8 sm:p-10 space-y-8 min-h-[460px]">
          ...
          {activeTab === 'basic' && (
            <div className="space-y-7 max-w-3xl">
              <div>
                <h3 className="text-xl font-extrabold text-[#0A1629] dark:text-white">Basic information</h3>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        ...
                        className="text-xs font-extrabold text-[#3B52D4] hover:underline cursor-pointer"
                      >
                        + Add new
                      </button>
                    </div>
          ...
          {activeTab === 'vital' && (
            <div className="space-y-7 max-w-3xl">
              <div>
                <h3 className="text-xl font-extrabold text-[#0A1629] dark:text-white">Vital information</h3>
                <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-sm font-bold text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-[#0A1629] dark:focus:ring-white transition-all shadow-2xs"
                  />
                </div>
          ...
          {activeTab === 'variations' && (
            <div className="space-y-7 max-w-3xl">
              <div>
                <h3 className="text-xl font-extrabold text-[#0A1629] dark:text-white">Variations and price</h3>
                <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
              ...
              <div className="space-y-4 pt-4 border-t border-slate-100 dark:border-slate-800">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  {variations.map((val) => (
                    ...
                    >
                      <Tag className="w-3 h-3 text-[#0A1629] dark:text-white" />
                      <span>{val}</span>
                      <button
                        type="button"
                ...
                <div className="flex items-center gap-2.5 max-w-md">
                  <input
                    ...
                    className="flex-1 px-4 py-3 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-sm text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-[#0A1629] dark:focus:ring-white transition-all shadow-2xs"
                  />
                  <button
                    type="button"
                    onClick={handleAddVariation}
                    className="px-5 py-3 bg-[#0A1629] hover:bg-black dark:bg-white dark:hover:bg-slate-200 text-white dark:text-black font-extrabold text-sm rounded-xl transition cursor-pointer shadow-xs"
                  >
                    Add
                  </button>
                </div>
          ...
          {activeTab === 'images' && (
            <div className="space-y-7 max-w-3xl">
              <div>
                <h3 className="text-xl font-extrabold text-[#0A1629] dark:text-white">Product Image *</h3>
                <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
              ...
              {mainImages.length > 0 ? (
                ...
                >
                  ...
                  {isDraggingImage && (
                    <div className="absolute inset-0 bg-indigo-600/80 backdrop-blur-xs flex flex-col items-center justify-center text-white gap-2 z-20">
                ...
                <label
                  ...
                  className={`border-2 border-dashed rounded-3xl p-12 flex flex-col items-center justify-center text-center cursor-pointer transition-all min-h-[380px] w-full select-none ${
                    isDraggingImage
                      ? 'border-[#0A1629] dark:border-white bg-indigo-50/70 dark:bg-indigo-950/40 ring-4 ring-[#0A1629]/10 scale-[1.01]'
                      : isUploadingImage
                      ? 'border-[#0A1629] bg-indigo-50/50 dark:bg-indigo-950/30'
                      : 'border-slate-300 dark:border-slate-700 hover:border-[#0A1629] dark:hover:border-white bg-slate-50/50 dark:bg-slate-800/40 hover:bg-slate-100/60 dark:hover:bg-slate-800/70'
                  }`}
                >
                  <input
                    type="file"
                  ...
                  />
                  {isUploadingImage ? (
                    <div className="flex flex-col items-center gap-3 text-[#0A1629] dark:text-white">
          ...
          {activeTab === 'descriptions' && (
            <div className="space-y-7 max-w-3xl">
              <div>
                <h3 className="text-xl font-extrabold text-[#0A1629] dark:text-white">Descriptions</h3>
                <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
              ...
              <div className="space-y-5">
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-sm font-mono text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-[#0A1629] dark:focus:ring-white transition-all shadow-2xs placeholder:text-slate-400"
                  />
                </div>
              </div>
            </div>
