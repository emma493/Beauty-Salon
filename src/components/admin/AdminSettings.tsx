...
export const AdminSettings: React.FC<AdminSettingsProps> = () => {
  ...
  const handlePasswordReset = (e: React.FormEvent) => {
    ...
    const success = updateAdminPassword(prevPass, newPass);
    if (success) {
      setPrevPass('');
      setNewPass('');
      setConfirmPass('');
    ...
    <div className="max-w-5xl mx-auto space-y-6 pb-12">
      ...
      <div className="bg-white dark:bg-slate-800/90 rounded-3xl p-6 border border-slate-100 dark:border-slate-700/60 shadow-xs flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <span className="inline-flex items-center gap-1.5 bg-[#D1F28B] text-[#244503] font-black text-xs px-3 py-1.5 rounded-full">
        ...
        <div className="lg:col-span-7 bg-white dark:bg-slate-800/90 rounded-3xl border border-slate-100 dark:border-slate-700/60 shadow-xs overflow-hidden flex flex-col">
          ...
          <form onSubmit={handleSaveCompanyInfo} className="p-6 space-y-6 flex-1 flex flex-col justify-between text-xs">
            <div className="space-y-5">
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl font-medium text-slate-900 dark:text-white text-sm focus:outline-none focus:ring-2 focus:ring-[#486B1C] transition"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="p-4 bg-slate-50 dark:bg-slate-800/60 rounded-2xl border border-slate-200 dark:border-slate-700 flex flex-col sm:flex-row items-center gap-4">
                  <div className="w-16 h-16 rounded-2xl bg-[#486B1C] text-white flex items-center justify-center border border-slate-200 dark:border-slate-700 shrink-0 overflow-hidden shadow-xs">
                    {companyLogoUrl ? (
                      <img
                        src={companyLogoUrl}
                        alt="Logo Preview"
                  ...
                  <div className="flex-1 w-full min-w-0 space-y-2">
                    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
                      ...
                      />
                      <label className="inline-flex items-center justify-center gap-1.5 px-4 py-2.5 bg-[#486B1C] hover:bg-[#385316] text-white font-bold text-xs rounded-xl cursor-pointer transition shrink-0 shadow-xs">
                        {isUploadingLogo ? (
                          <>
              ...
              <div className="space-y-1.5">
                ...
                <CustomSelect
                  ...
                  icon={<DollarSign className="w-4 h-4 text-[#486B1C]" />}
                />
              </div>
            ...
            <div className="pt-6">
              <button
                type="submit"
                className="w-full py-3.5 bg-[#486B1C] hover:bg-[#385316] text-white font-bold text-sm rounded-xl shadow-xs transition flex items-center justify-center gap-2 cursor-pointer"
              >
          ...
          <form onSubmit={handlePasswordReset} className="p-6 space-y-6 flex-1 flex flex-col justify-between text-xs">
            <div className="space-y-4">
              <div className="p-4 bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 rounded-2xl flex items-start gap-3">
                <ShieldCheck className="w-5 h-5 text-[#486B1C] dark:text-[#D1F28B] shrink-0 mt-0.5" />
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full pl-4 pr-11 py-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl font-medium text-slate-900 dark:text-white text-sm focus:outline-none focus:ring-2 focus:ring-[#486B1C] transition"
                  />
                  <button
                    type="button"
