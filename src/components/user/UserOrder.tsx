            ...
            <div className="flex items-center gap-3">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-4 py-3 bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-full text-xs font-semibold text-slate-900 dark:text-white placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-[#486B1C] shadow-2xs"
                />
              </div>
            </div>
                ...
                return (
                  <button
                    ...
                    className={`px-5 py-2.5 rounded-full text-xs font-extrabold whitespace-nowrap transition-all cursor-pointer ${
                      isActive
                        ? 'bg-[#1D1D21] text-white dark:bg-slate-100 dark:text-slate-900 shadow-2xs'
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between">
                        <span className="px-3 py-1 bg-[#486B1C]/10 text-[#486B1C] dark:bg-lime-950/80 dark:text-lime-300 font-extrabold text-[11px] rounded-full">
                          {p.quantityInStock} Stock
                        </span>
                      </div>

                      {/* Product Image Container */}
                      <div className="w-full h-36 bg-[#F4F5F7] dark:bg-slate-800/80 rounded-2xl p-3 flex items-center justify-center overflow-hidden">
                        {p.imageUrl ? (
                          <img
                            src={p.imageUrl}
                            alt={p.name}
                      ...
                      {currentQty > 0 ? (
                        <div className="w-full py-1.5 px-3 bg-[#486B1C] text-white rounded-xl flex items-center justify-between font-extrabold text-xs shadow-2xs">
                          <button
                            onClick={() => updateCartQuantity(p.id, currentQty - 1)}
                            className="p-1 hover:bg-[#3b5817] rounded-lg transition"
            ...
            <div className="space-y-4 flex-1">
              ...
              <div className="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800">
                <h3 className="text-base font-black text-slate-900 dark:text-white flex items-center gap-2">
                  ...
                  {cart.length > 0 && (
                    <span className="w-5 h-5 bg-[#EEF2FF] text-[#3B52D4] dark:bg-indigo-950 dark:text-indigo-300 text-[11px] font-black rounded-full flex items-center justify-center">
                      {cart.length}
                    </span>
                  )}
                </h3>
                ...
                <div className="space-y-3 max-h-[340px] overflow-y-auto pr-1 scrollbar-none">
                  {cart.map((item) => {
                    return (
                      <div
                        key={item.product.id}
                        className="flex items-center justify-between gap-3 p-2 bg-[#F8F9FB] dark:bg-slate-800/50 rounded-2xl border border-slate-100 dark:border-slate-800/80 text-xs"
                      >
                        {/* Thumbnail */}
            ...
            <div className="pt-4 border-t border-slate-100 dark:border-slate-800 space-y-3">
              <div className="space-y-2 text-xs font-bold text-slate-500 dark:text-slate-400">
                <div className="flex items-center justify-between text-slate-900 dark:text-white">
                  ...
                  <span className="text-xl font-black text-[#1D1D21] dark:text-white">
              ...
              <button
                ...
                className="w-full py-4 bg-[#486B1C] hover:bg-[#3b5817] disabled:bg-slate-200 dark:disabled:bg-slate-800 disabled:text-slate-400 text-white font-black text-sm rounded-2xl shadow-lg shadow-lime-900/10 active:scale-98 transition flex items-center justify-center gap-2 cursor-pointer"
              >
                <span>Continue</span>
              </button>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start max-w-5xl mx-auto">
          ...
          <div className="lg:col-span-7 bg-white dark:bg-slate-900 p-6 md:p-8 rounded-3xl border border-slate-200/80 dark:border-slate-800 shadow-2xs space-y-6">
            <div className="flex items-center gap-3 border-b border-slate-100 dark:border-slate-800 pb-4">
              <div className="w-10 h-10 rounded-2xl bg-[#486B1C]/10 text-[#486B1C] dark:bg-lime-950/80 dark:text-lime-300 flex items-center justify-center shrink-0">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-11 pr-4 py-3 bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700/80 rounded-2xl text-xs font-bold text-slate-900 dark:text-white placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-[#486B1C] transition"
                  />
                </div>
              </div>
            ...
            <div className="flex items-center gap-3 pt-4 border-t border-slate-100 dark:border-slate-800">
              ...
              <button
                ...
                className="flex-1 py-3.5 bg-[#486B1C] hover:bg-[#3b5817] text-white font-extrabold text-xs rounded-2xl shadow-lg shadow-lime-900/10 transition flex items-center justify-center gap-2 cursor-pointer active:scale-98"
              >
          ...
          <div className="lg:col-span-5 bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-200/80 dark:border-slate-800 shadow-2xs space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800">
              ...
              <span className="px-2.5 py-1 bg-[#486B1C]/10 text-[#486B1C] dark:bg-lime-950 dark:text-lime-300 text-[11px] font-black rounded-full">
            ...
            <div className="pt-3 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between">
              ...
              <span className="text-lg font-black text-[#486B1C] dark:text-lime-400">
                {currencySymbol}{subtotal.toFixed(2)}
              </span>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start max-w-5xl mx-auto">
            ...
            <div className="bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-200/80 dark:border-slate-800 shadow-2xs space-y-4">
              <div className="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800">
                <h4 className="text-sm font-black text-slate-900 dark:text-white flex items-center gap-2">
                  <Package className="w-4 h-4 text-[#486B1C]" />
          ...
          <div className="lg:col-span-5 bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-200/80 dark:border-slate-800 shadow-2xs space-y-6 sticky top-4">
            ...
            <div className="space-y-3 text-xs font-bold text-slate-500 dark:text-slate-400">
              ...
              <div className="p-4 bg-[#486B1C]/10 dark:bg-lime-950/60 rounded-2xl border border-lime-200 dark:border-lime-900/50 flex items-center justify-between mt-4">
                <span className="text-xs font-black text-slate-900 dark:text-lime-200">Total Amount Due</span>
                <span className="text-xl font-black text-[#486B1C] dark:text-lime-300">
            ...
            <div className="space-y-2.5 pt-2">
              <button
                type="button"
                onClick={handlePaid}
                className="w-full py-4 bg-[#486B1C] hover:bg-[#3b5817] text-white font-black text-sm rounded-2xl shadow-lg shadow-lime-900/10 flex items-center justify-center gap-2 transition active:scale-98 cursor-pointer"
              >
          ...
          <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-2xl border border-slate-200 dark:border-slate-800 p-6 sm:p-8 space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 dark:border-slate-800 pb-5">
              <div className="flex items-center gap-3.5">
                <div className="w-14 h-14 rounded-2xl bg-[#486B1C]/10 dark:bg-emerald-950/60 p-2.5 flex items-center justify-center shrink-0 border border-[#486B1C]/20 dark:border-emerald-800/60">
                  <CheckCircle2 className="w-8 h-8 text-[#486B1C] dark:text-emerald-400" />
                </div>
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    <span className="px-2.5 py-0.5 rounded-md bg-[#486B1C]/10 dark:bg-emerald-950/80 text-[#486B1C] dark:text-emerald-300 font-mono font-bold text-xs">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
              <div className="p-3.5 bg-slate-50 dark:bg-slate-800/50 rounded-2xl space-y-1 border border-slate-100/80 dark:border-slate-800">
                ...
                <div className="font-extrabold text-lg text-[#486B1C] dark:text-emerald-400">
            ...
            <div className="space-y-3 pt-2">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <button
                  ...
                  className="w-full py-3.5 bg-[#486B1C] hover:bg-[#3d5a17] text-white font-black text-xs rounded-2xl shadow-lg shadow-[#486B1C]/20 flex items-center justify-center gap-2 transition cursor-pointer active:scale-98"
                >
              ...
              {onOrderComplete && (
                <button
                  ...
                  className="w-full py-2.5 text-slate-500 hover:text-[#486B1C] dark:hover:text-emerald-400 font-extrabold text-xs transition cursor-pointer inline-flex items-center justify-center gap-1"
                >
      ...
      {step === 'completed' && !activeCompletedOrder && (
        <div className="max-w-md mx-auto bg-white dark:bg-slate-900 p-8 rounded-3xl border border-slate-200/80 dark:border-slate-800 text-center space-y-4 my-8 shadow-lg">
          ...
          <button
            type="button"
            onClick={() => setStep('cart')}
            className="w-full py-3 bg-[#486B1C] hover:bg-[#3d5a17] text-white font-extrabold text-xs rounded-xl shadow-md transition cursor-pointer"
          >
            Start New Order
          </button>
        </div>
