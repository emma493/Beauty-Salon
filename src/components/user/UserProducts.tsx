          ...
          {filteredProducts.map((p) => {
            ...
            return (
              ...
              >
                ...
                <div className="relative w-full aspect-square bg-[#F4F5F7] dark:bg-slate-800/80 rounded-2xl p-4 flex items-center justify-center overflow-hidden">
                  {p.imageUrl ? (
                    <img
                      src={p.imageUrl}
                      alt={p.name}
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center justify-between sm:justify-end gap-4 shrink-0">
                  ...
                  <button
                    onClick={() => setDetailProduct(p)}
                    className="flex items-center gap-1.5 px-3.5 py-2 bg-slate-100 hover:bg-[#486B1C] hover:text-white dark:bg-slate-800 text-slate-700 dark:text-slate-200 font-extrabold text-xs rounded-xl transition"
                  >
