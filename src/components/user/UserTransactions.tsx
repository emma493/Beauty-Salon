...
export const UserTransactions: React.FC = () => {
  ...
  }, [orders, currentUser, searchTerm, timePreset, selectedDate, statusFilter]);
        ...
        {paginatedOrders.length === 0 ? (
          <div className="p-16 text-center text-slate-400 space-y-3">
            ...
            <p className="text-xs text-slate-400">
              {searchTerm || selectedDate || timePreset !== '24h'
          ...
          <>
                        ...
                        <td className="py-4 px-6 text-right whitespace-nowrap">
                          <div className="flex items-center justify-end gap-1.5">
                            <button
                              ...
                              className="px-2.5 py-1.5 rounded-xl bg-slate-100 hover:bg-[#486B1C] hover:text-white dark:bg-slate-800 dark:hover:bg-[#486B1C] text-slate-700 dark:text-slate-200 font-bold text-xs transition flex items-center gap-1 cursor-pointer"
                ...
                return (
                  <div key={order.id} className="p-4 space-y-3">
                    ...
                    <div className="flex items-center gap-2 pt-2 border-t border-slate-100 dark:border-slate-800">
                      <button
                        onClick={() => setPreviewOrder(order)}
                        className="flex-1 py-2 bg-slate-100 hover:bg-[#486B1C] hover:text-white dark:bg-slate-800 dark:hover:bg-[#486B1C] text-slate-700 dark:text-slate-200 font-bold text-xs rounded-xl transition flex items-center justify-center gap-1.5 cursor-pointer"
                      >
                        <Eye className="w-3.5 h-3.5" />
            ...
            <div className="p-4 border-t border-slate-200/80 dark:border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs font-semibold text-slate-500">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <div className="px-3 py-1.5 rounded-lg bg-[#486B1C] text-white font-bold">
                  {currentPage}
                </div>
              ...
              <div className="flex items-center justify-between pb-2 border-b border-slate-200 dark:border-slate-700">
                <div className="flex items-center gap-2">
                  {settings.companyLogoUrl ? (
                    ...
                    <div className="w-6 h-6 rounded-md bg-[#486B1C] text-white font-black text-xs flex items-center justify-center">
                      POS
                    </div>
                  )}
