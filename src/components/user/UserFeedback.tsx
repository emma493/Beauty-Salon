...
export const UserFeedback: React.FC = () => {
  ...
  return (
    <div className="space-y-4 max-w-4xl mx-auto font-sans">
      ...
      {/* WhatsApp Chat Body */}
      <div className="bg-[#efeae2] dark:bg-[#0b141a] rounded-b-3xl border border-slate-300 dark:border-slate-800 shadow-xl overflow-hidden flex flex-col h-[540px]">
        {/* Messages Container */}
        <div
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    >
                      <span>{timeStr}</span>
                      {isWorker && <CheckCheck className="w-3.5 h-3.5 text-[#53bdeb] inline" />}
                    </div>
                  </div>
                </div>
              );
        ...
        {showAttachInput && (
          <div className="p-3 bg-slate-100 dark:bg-[#111b21] border-t border-slate-200 dark:border-slate-800 flex items-center gap-2 text-xs">
            ...
            <input
              ...
              className="flex-1 px-3 py-1.5 bg-white dark:bg-[#202c33] border border-slate-300 dark:border-slate-700 rounded-xl text-slate-900 dark:text-white"
            />
            <button
              type="button"
