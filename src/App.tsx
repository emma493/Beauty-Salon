...
const MainAppContent: React.FC = () => {
  ...
  if (!isAuthenticated) {
    return (
      <div className="min-h-screen w-full bg-[#E3E5ED] dark:bg-slate-950 text-slate-900 dark:text-white font-sans antialiased">
        <LoginModal />
        <ToastContainer />
      </div>
    );
  ...
  return (
    <div className="h-screen w-full bg-[#F8F9FB] dark:bg-slate-950 text-slate-800 dark:text-slate-100 font-sans antialiased flex flex-col overflow-hidden">
      ...
      <div className="w-full h-screen flex flex-col md:flex-row flex-1 overflow-hidden">
        ...
        <div className="flex-1 flex flex-col min-w-0 bg-[#F8F9FB] dark:bg-slate-900/50 h-screen overflow-hidden">
          {/* Header Navbar */}
          <Header />
